      ...
      <div className="bg-white rounded-lg shadow p-6">
        <form onSubmit={handleUpdate} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Flat Name</label>
              <input
                type="text"
                name="flatName"
                required
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Fee Due Date (Day)</label>
              <input
                type="number"
                name="feeDueDate"
                required
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 pt-4 border-t border-gray-100">
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <div className="text-sm font-semibold text-gray-900">{student.flatName} - {student.flatNo}</div>
          </div>
        </div>
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <div className="text-sm font-bold text-green-600">PKR{student.monthlyFee.toLocaleString()}</div>
          </div>
        </div>
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <div className="text-sm font-semibold text-gray-900">{student.feeDueDate || 10}th of each month</div>
          </div>
        </div>
      </div>
      {!student.isActive && (
